...
def build_system_prompt(
    ...
    *,
    ...
    return (
        ...
        "WHILE check_availability OR book_meeting RUNS: say ONE short, natural line "
        "(e.g. \"Let me check our calendar — one moment.\") then WAIT for the result; "
        ...
        "all set.\" or \"No problem.\"), then END THE CALL. The platform delivers the "
        "closing line and hangs up for you — do NOT speak a goodbye yourself, do NOT say "
        "\"one moment\" / \"just a sec\" to end, and NEVER keep talking once you have "
        "decided to end. Never improvise a non-compliant promise."
    )
